        ...
        <div class="form-group">
          ...
          <div class="range-wrapper">
            <input
              ...
              list="sizeList"
              oninput="
                document.getElementById('sizeOutput').value = event.target.value == 1 ? 
                'Kecil' : event.target.value == 2 ? 
                'Sedang' : 'Besar'
              "
            />
...
function StylingAccentColorInput26() {
  return (
    <StaticWebSandpack files={files} />
  );
}

export default StylingAccentColorInput26;
