...
<html lang="en">
  <head>
    ...
    <title>Pesan Hotel Bandung</title>
      ...
      <div class="form-input">
        ...
        <form>
          <div class="segment-1">
            ...
            <label for="tunai">Tunai</label><br /><input
              type="radio"
              id="nonTunai"
              name="payment"
              value="2"
          ...
          <div class="segment-3">
            ...
            <div class="check-in">
              ...
              <input type="date" id="checkIn" value="2020-01-01" required />
            </div>
            <div class="check-out">
              <label for="checkOut">Tanggal Check-Out</label>
              <input type="date" id="checkOut" value="2020-01-02" required />
            </div>
          ...
          <div class="segment-4">
            ...
            <label for="agreement"
              >Dengan ini saya setuju dengan syarat dan ketentuan berlaku</label
            >
          </div>
...
function ScreenReaderExperience11() {
  return (
...
export default ScreenReaderExperience11;
